...
const Login = () => {
    ...
    return (
        <>
            ...
            >
                <Box sx={{ position: 'absolute', width: '92%', height: '95%', display: 'flex', justifyContent: 'center', border: 1, borderRadius: 2, backdropFilter: 'blur(5px)', background: 'rgba(0,0,0,0.2)', m: 2 }}>
                    <Grid container item md={8} sx={{ margin: 'auto', px: 2 }}>
