...
import { TextField, Paper, Grid, Stack, Button, Box, IconButton } from '@mui/material';
import { useDispatch, useSelector } from 'react-redux';
import { useFormik } from 'formik';
import * as Yup from 'yup';
import { toast } from 'react-toastify';
import { IMG_BASE_URL } from '../../../../utils/Constants';
import { updatedProfile } from '../../../../reduxSlice/recruiterSlice';
import { Edit } from '@mui/icons-material';

const ProfileUpdate = () => {
    const dispatch = useDispatch();
    const { loading, error, recruiter } = useSelector((state) => state.RECRUITER);
    ...
    const formik = useFormik({
        initialValues: {
            first_name: recruiter?.name?.first_name || '',
            last_name: recruiter?.name?.last_name || '',
                        ...
                        sx={{
                            ...
                            backgroundImage: previewImage
                                ...
                                : recruiter?.profileImage
                                    ? `url(${IMG_BASE_URL}/uploads/${recruiter?.profileImage})`
