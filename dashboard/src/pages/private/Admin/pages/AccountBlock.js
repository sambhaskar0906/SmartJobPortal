...
import { Box, Typography, Paper, TableContainer, Table, Skeleton, TableHead, TableRow, TableCell, TableBody, TablePagination, Grid, OutlinedInput, Chip, } from "@mui/material";
import { useDispatch, useSelector } from "react-redux";
import { unwrapResult } from "@reduxjs/toolkit";
import { useTheme } from "@emotion/react";
import { debounce } from 'lodash';
import { IMG_BASE_URL } from "../../../../utils/Constants.js";
import { fetchInactiveRecruiters, inActiveStatus } from "../../../../reduxSlice/recruiterSlice.js";
...
const AccountBlock = () => {
    ...
    const { recruiterDetails } = useSelector((state) => state.RECRUITER);
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const resultAction = await dispatch(fetchInactiveRecruiters());
